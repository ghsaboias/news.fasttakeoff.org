/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f870347d02735a7eccc452a5c13efbc8)
// Runtime types generated with workerd@1.20250902.0 2025-03-11 nodejs_compat
export declare namespace Cloudflare {
	interface Env {
		...
		EXECUTIVE_SUMMARIES_CACHE: KVNamespace;
		MKTNEWS_CACHE: KVNamespace;
		MKTNEWS_SUMMARIES_CACHE: KVNamespace;
		CRON_STATUS_CACHE: KVNamespace;
		DISCORD_DISABLED: "";
		...
		INSTAGRAM_R2_PUBLIC_URL: string;
		INSTAGRAM_IMAGES: R2Bucket;
		DB: D1Database;
		FAST_TAKEOFF_NEWS_DB: D1Database;
		CRON_METRICS: AnalyticsEngineDataset;
		ASSETS: Fetcher;
	}
}
