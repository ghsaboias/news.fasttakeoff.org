...
Response format (JSON):
{
  "factCheck": {
    ...
    EXECUTIVE_SUMMARIES: {
        ...
        PROMPT_TEMPLATE: `Create a concise executive summary in Markdown of the following news reports, focusing on the most important events of the last 6 hours. Use clear headlines and bullet points. Do not include any commentary, speculation, and NEVER include a title (like "Executive Summary", or "Executive Summary: Key Global Developments (Past 6 Hours)"). Only include events that are significant and newsworthy.\n\nPREVIOUS EXECUTIVE SUMMARIES (if any):\n{previousExecutiveSummaries}\n\nREPORTS TO ANALYZE:\n"""\n{reportBody}\n"""\n\nRespond ONLY with valid Markdown summarizing the most important events of the last 6 hours.`,
